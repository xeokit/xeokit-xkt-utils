        ...
        for (let tileEntityIndex = firstTileEntityIndex; tileEntityIndex < lastTileEntityIndex; tileEntityIndex++) {
            ...
            for (let primitiveInstancesIndex = firstmeshIndex; primitiveInstancesIndex < lastmeshIndex; primitiveInstancesIndex++) {
                ...
                if (isReusedPrimitive) {
                    ...
                    //
                    for (let k = 0, lenk = primitivePositions.length; k < lenk; k += 3) {

                        primitivePositions[k + 0] += tileCenter[0];
                        primitivePositions[k + 1] += tileCenter[1];
                        primitivePositions[k + 2] += tileCenter[2];

                        // primitivePositions[k + 0] += 15;
                        // primitivePositions[k + 1] += 15;
                        // primitivePositions[k + 2] += 15;
                    }
